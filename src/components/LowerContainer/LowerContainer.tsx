...
const ListOfPoints = ["He never failed math. This is a popular “fact” promoted on the internet, maybe in an attempt to relate to genius. However, it is simply not true. Overall, Einstein was an average student, but math was one area where he excelled, unsurprisingly.",
...
const LowerContainer: React.FC<Props> = (props: Props) => {
    return (<div>
        <div className={"lower-container"}>
            <ul> {ListOfPoints.map((point) => <UnorderedListItem text={point}/>)}</ul>
            ...
            <TitleComponent
                text={" -- Albert Einstein"} fontSize={"0.8rem"}/>
        </div>
